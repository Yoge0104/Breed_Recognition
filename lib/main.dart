...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    Navigator.of(context).pushReplacementNamed(DemoScreen.routeName);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final bool isWide = mediaQuery.size.width >= 800;
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Sign in to explore AI-powered breed recognition.',
